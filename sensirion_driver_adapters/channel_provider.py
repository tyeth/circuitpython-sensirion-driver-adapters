...
class I2cChannelProvider(abc.ABC):
    ...
    def __enter__(self) -> "I2cChannelProvider":
    ...
    def try_create_crc_calculator(parameters: Optional[Tuple[int, int, int, int]]) -> Optional[CrcCalculator]:
        """Evaluate the parameters. If not None, create a CrcCalculator instance. Otherwise, return None."""
